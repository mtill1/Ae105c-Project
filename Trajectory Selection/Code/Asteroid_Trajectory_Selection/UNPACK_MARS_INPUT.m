function [et_launch, et_mars, et_arrive_1, et_stay_1, et_arrive_2, ...
    ...
    t_mars = input_vec_scaled(2);
    t_arrive_1 = input_vec_scaled(3);
    t_stay_1 = input_vec_scaled(4);
    t_arrive_2 = input_vec_scaled(5);
    t_stay_2 = input_vec_scaled(6);
    t_arrive_3 = input_vec_scaled(7);
