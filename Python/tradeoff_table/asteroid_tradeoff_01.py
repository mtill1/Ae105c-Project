"""Asteroid trade-off table generator v3 — enhanced science scoring.

Two-component science score:
  A: Characterisation depth (40%)
  B: Intrinsic science interest (60%) with manual flags

Uses log-Chebyshev for mass/radius and percentile-rank for other criteria.
"""
...
def safe_num(df, name):
    ...
    print(f'  [warn] column "{name}" not found — NaN.')
